...
# upper left plot
plot(weekDays, hpc$globalActivePower, type= "l", ylab='Global Active Power', xlab="")

# upper right plot
plot(weekDays, hpc$voltage, type="l", ylab="Voltage", xlab="datetime")
...
legend("topright", c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), lty=c(1,1), lwd=c(2.5,2.5,2.5),col=c("black", "red","blue"), bty="n")

# lower right plot
plot(weekDays, hpc$globalReactivePower, type="l", ylab="Global_reactive_power", xlab="datetime")
